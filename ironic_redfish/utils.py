...
def get_system(node):
    ...
    @retrying.retry(
        retry_on_exception=(
            lambda e: isinstance(e, ironic_redfish.RedfishConnectionError)),
    ...
    def _get_system():
        try:
            ...
            raise ironic_redfish.RedfishError(error=e)
        ...
        # retrying on them
            ...
            raise ironic_redfish.RedfishConnectionError(node=node.uuid,
                                                        error=e)

    try:
        return _get_system()
    except ironic_redfish.RedfishConnectionError as e:
